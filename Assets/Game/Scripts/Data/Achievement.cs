...
public class Achievement
{
    ...
    public Achievement(string title, string description, float progress, AchievementRewardType rewardType, AchievementType type, int quantityOrIdx, int amountToComplete)
    {
        this.title = title;
